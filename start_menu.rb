...
require "English"
require "time"
require "/media/sklad3/home_wirtaw/programs/Aptana/khl/dashboard_khl.rb"
require "/media/sklad3/home_wirtaw/programs/Aptana/khl/team.rb"
require "/media/sklad3/home_wirtaw/programs/Aptana/khl/work_json.rb"
...
class StartQT4 < Qt::MainWindow
  ...
  def initialize parent=nil
    ...
    si.icon = Qt::Icon.new('/media/sklad3/home_wirtaw/programs/Aptana/khl/khl_logo2.png')
    si.show
    
    @filename = "/media/sklad3/home_wirtaw/programs/Aptana/khl/data.json"
    @jsondata = Read_JSON(@filename)
    @filename2 = "/media/sklad3/home_wirtaw/programs/Aptana/khl/pre_data.json"
